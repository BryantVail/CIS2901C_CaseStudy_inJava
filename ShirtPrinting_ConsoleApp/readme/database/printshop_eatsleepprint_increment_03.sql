...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2022 at 06:40 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `customers_updateEmailAddress` (`customerId` INT, `newEmailAddress` VARCHAR(255))   Begin 
        UPDATE Customers 
            SET 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `customers_updateFirstName` (IN `customerId` INT, IN `newFirstName` VARCHAR(255))  DETERMINISTIC Begin 
        UPDATE Customers 
            SET 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `customers_updateLastName` (IN `customerId` INT, IN `newLastName` VARCHAR(255))  DETERMINISTIC Begin 
        UPDATE Customers 
            SET 
...
(1020304, 'email_new@email.com', 'Jerry', 'McGuiness', b'0', '2022-09-21 21:19:07', '2022-11-29 00:10:49'),
...
(1020336, 'bryantvail@gmail.com', 'bryant', 'test', b'0', '2022-09-21 21:19:07', '2022-10-18 23:47:58'),
...
(1020395, 'email@emailEmail.com', 'BryBry', 'VailVail', b'0', '2022-10-18 23:30:53', '2022-10-18 23:30:53'),
(1020396, 'bryanttv@outlook.com', 'testFirstName', 'testLastName', b'0', '2022-11-29 00:36:43', '2022-11-29 00:36:43'),
(1020397, 'email_2022-11-29T00:36:43.590054500@gmail.com', 'firstName', 'lastName', b'0', '2022-11-29 00:36:43', '2022-11-29 00:36:43');
...
--
ALTER TABLE `customers`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1020398;
